...
We will spend the rest of March working on polishing the paper and the research. We will focus heavily on any feedback we get from the our initial proposal. During this time we will also continue analyzing our research in order to draw conclusions.
\begin{itemize}
...
Finally, in April, we will begin to . We will also start working on our presentation. We intend to fully prepare the presentation at least in week in advanced in order to get feedback before we present to the class. 
\begin{itemize}
